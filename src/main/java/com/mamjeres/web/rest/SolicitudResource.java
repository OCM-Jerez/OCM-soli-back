...
/**
 * REST controller for managing {@link com.mamjeres.domain.Solicitud}.
 */
@RestController
@RequestMapping("/api")
public class SolicitudResource {
    ...
    public ResponseEntity<SolicitudDTO> updateSolicitud(@Valid @RequestBody SolicitudDTO solicitudDTO) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, solicitudDTO.getId().toString()))
            .body(result);
    }
